    ...
    <div className="space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <Link
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-slate-900 hover:bg-slate-800 dark:bg-amber-500 dark:hover:bg-amber-400 dark:text-slate-950 text-white rounded-lg text-sm font-semibold shadow-sm transition-colors"
            >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-6">
          ...
          <div className="bg-white dark:bg-slate-900 p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex items-center justify-between transition-colors">
            <div>
              ...
              <span className="inline-flex items-center gap-1 text-xs text-emerald-600 dark:text-emerald-400 font-medium mt-1">
          ...
          <div className="bg-white dark:bg-slate-900 p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex items-center justify-between transition-colors">
            ...
            <div className="w-12 h-12 rounded-xl bg-blue-50 dark:bg-blue-500/10 text-blue-600 dark:text-blue-400 flex items-center justify-center font-bold text-xl">
          ...
          <div className="bg-white dark:bg-slate-900 p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex items-center justify-between transition-colors">
            <div>
              ...
              <span className="inline-flex items-center gap-1 text-xs text-slate-500 dark:text-slate-400 mt-1">
          ...
          <div className="bg-white dark:bg-slate-900 p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex items-center justify-between transition-colors">
            <div>
              ...
              <span className="text-xs text-amber-700 dark:text-amber-400 mt-1 block font-medium">
                {rfis.length} Pending RFIs &bull; {punchItems.length} Punch Items
              </span>
            </div>
            <div className="w-12 h-12 rounded-xl bg-rose-50 dark:bg-rose-500/10 text-rose-600 dark:text-rose-400 flex items-center justify-center">
      ...
      <div>
        ...
        {projects.length === 0 ? (
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-dashed border-slate-300 dark:border-slate-800 p-10 text-center">
            ...
            <h3 className="text-base font-bold text-slate-800 dark:text-slate-200">No Projects Created Yet</h3>
              ...
              return (
                ...
                >
                  <div className="h-36 relative overflow-hidden bg-slate-100 dark:bg-slate-800">
                    ...
                    <div className="absolute bottom-2 left-3 bg-slate-950/80 backdrop-blur px-2.5 py-0.5 rounded text-white text-[11px] font-mono font-semibold">
                      {project.code}
                    </div>
                  </div>
                  ...
                  <div className="p-5 flex-1 flex flex-col justify-between">
                    <div>
                      ...
                      <div className="mt-3 text-xs text-slate-600 dark:text-slate-400 flex items-center gap-1">
                        <span className="font-semibold text-slate-800 dark:text-slate-200">Client:</span> {project.client_name}
                      </div>
                    </div>
                    ...
                    <div className="mt-5 pt-4 border-t border-slate-100 dark:border-slate-800 space-y-3">
                      <div>
                        <div className="flex justify-between text-xs font-semibold mb-1">
                          <span className="text-slate-600 dark:text-slate-400">Financial Progress</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-slate-900 p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm transition-colors">
          ...
          {tasks.length === 0 ? (
            <p className="text-xs text-slate-400 dark:text-slate-500 py-6 text-center">No tasks recorded in database yet.</p>
          ) : (
            <div className="space-y-2.5">
              {tasks.map((task) => (
                <div
                  key={task.id}
                  className="p-3 bg-slate-50 dark:bg-slate-800/60 rounded-lg border border-slate-200/80 dark:border-slate-800 flex items-center justify-between gap-3"
                >
        ...
        <div className="bg-white dark:bg-slate-900 p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm transition-colors">
          ...
          {rfis.length === 0 ? (
            <p className="text-xs text-slate-400 dark:text-slate-500 py-6 text-center">No RFIs submitted in database yet.</p>
          ) : (
            <div className="space-y-2.5">
              {rfis.map((rfi) => (
                <div
                  key={rfi.id}
                  className="p-3 bg-slate-50 dark:bg-slate-800/60 rounded-lg border border-slate-200/80 dark:border-slate-800 space-y-1.5"
                >
